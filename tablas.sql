...
CREATE TABLE  IF NOT EXISTS INICIATIVAS(
	...
	VOTOS INT NOT NULL,
	PALABRACLAVE VARCHAR (50) UNIQUE NOT null,
...
ALTER TABLE PALABRASCLAVE ADD CONSTRAINT PK_PALABRASCLAVE PRIMARY KEY(ID,IDUSUARIO,IDINICIATIVA);
ALTER TABLE PALABRASCLAVE ADD CONSTRAINT FK_PALABRASCLAVE_IDU FOREIGN KEY(IDUSUARIO) REFERENCES USUARIOS(USUARIO);
